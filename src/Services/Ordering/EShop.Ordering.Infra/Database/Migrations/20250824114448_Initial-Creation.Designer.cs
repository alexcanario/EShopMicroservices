...
namespace EShop.Ordering.Infra.Database.Migrations
{
    ...
    [Migration("20250824114448_Initial-Creation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Ordering.Domain.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EShop.Ordering.Domain.Models.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("OrderName", "EShop.Ordering.Domain.Models.Order.OrderName#OrderName", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Payment", "EShop.Ordering.Domain.Models.Order.Payment#Payment", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("EShop.Ordering.Domain.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EShop.Ordering.Domain.Models.Order", b =>
                {
                    b.HasOne("EShop.Ordering.Domain.Models.Customer", null)
                        .WithMany()
